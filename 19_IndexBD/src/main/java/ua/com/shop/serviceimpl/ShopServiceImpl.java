...
public class ShopServiceImpl implements ShopService {
	...
	public void save(ShopForm form) {
		...
		shop.setPage(Integer.valueOf(form.getPage()));
	...
	public ShopForm findForm(int id) {
		...
		form.setPage(String.valueOf(shop.getPage()));
	...
	public Shop findUnique(String shyear, String shprice, String isbn,
			String edition, String page, TitleShop titleShop,
			SeriaPub seriaPub, Languages lang, Category category) {
		return shopDao.findUnique(Integer.valueOf(shyear), new BigDecimal(shprice.replace(',', '.')), isbn, Integer.valueOf(edition), Integer.valueOf(page), titleShop.getId(), seriaPub.getId(), lang.getId(), category.getId());
	}
