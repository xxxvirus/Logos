...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		...
		<div class="row">
			...
			<div class="col-md-1 col-xs-1"><h3>Dead</h3></div>
			...
			<c:forEach items="${authors}" var="author">
				<div class="row">
					...
					<div class="col-md-1 col-xs-1">${author.yearOfDead}</div>
					<div class="col-md-1 col-xs-1"><a href="${author.wiki}">Wiki</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-warning btn-xs" href="/admin/author/update/${author.id}">update</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-danger btn-xs" href="/admin/author/delete/${author.id}">delete</a></div>
				</div>
