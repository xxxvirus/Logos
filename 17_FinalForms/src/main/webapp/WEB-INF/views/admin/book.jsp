			...
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/book"
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:select class="form-control" path="author" id="author"
								itemValue="id">
					...
					<div class="form-group">
						<label for="book" class="col-sm-2 control-label">Pages</label>
						<div class="col-sm-7">
					...
					<div class="col-sm-7">
						<form:select path="genre" items="${genres}" multiple="true" itemValue="id" id="genreId"
 
itemLabel="nameOfG" class="form-control input-sm" />
					</div>
					</div>
