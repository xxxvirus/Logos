...
import ua.com.shop.specification.FilterByAuthorId;
...
//		}
	...
	@Override
	public Page<Shop> findByAuthor(Pageable pageable, ShopFilterByAuthorId filter, int id) {
		return shopDao.findAll(new FilterByAuthorId(filter, id), pageable);
	}
