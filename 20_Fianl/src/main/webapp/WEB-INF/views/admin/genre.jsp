...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		...
		<div class="row">
			<div class="col-md-4 col-xs-4"><h3>Genre name</h3></div>
			...
			<c:forEach items="${genres}" var="genre">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/genre/update/${genre.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/genre/delete/${genre.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
