		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/titleSh">TitleShop</a><span
...
<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/titleSh" method="POST" modelAttribute="titleSh">
					<div class="form-group">
    					<label for="publisher" class="col-sm-2 control-label">Original Title</label>
    					<div class="col-sm-7">
		...
		<div class="row">
			...
			<c:forEach items="${titleShops}" var="titheShop">
				<div class="row">
					<div class="col-md-3 col-xs-3">${titheShop.book.title}</div>
					<div class="col-md-3 col-xs-3">${titheShop.namePub}</div>
					<div class="col-md-3 col-xs-3"><a class="btn btn-warning btn-xs" href="/admin/titleSh/update/${titheShop.id}">update</a></div>
					<div class="col-md-3 col-xs-3"><a class="btn btn-danger btn-xs" href="/admin/titleSh/delete/${titheShop.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
