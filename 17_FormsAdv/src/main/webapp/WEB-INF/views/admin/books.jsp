...
<!-- 					тут все так само як на сервлетах -->
					<div class="col-md-2 col-xs-2">${books.title}</div>
					<div class="col-md-2 col-xs-2">${books.pages}</div>
					<div class="col-md-2 col-xs-2">${books.frirstpub}</div>
					<div class="col-md-2 col-xs-2">${books.author.name} ${books.author.surname}</div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-warning btn-xs" href="/admin/books/update/${books.id}">update</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-danger btn-xs" href="/admin/books/delete/${books.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
