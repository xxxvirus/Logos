...
<div class="row">
	...
	<div class="col-md-7 col-sm-12 col-xs-12">
		<form:form class="form-horizontal" action="/registration"
			...
			<div class="form-group">
				<label for="streat" class="col-sm-2 control-label">Streat</label>
				<div class="col-sm-7">
					<form:input class="form-control" path="streat" id="streat" />
				</div>
				<label class="col-sm-3 control-label" for="streat"
					style="color: red; text-align: left;"><form:errors
						path="streat" /></label>
			</div>
			<div class="form-group">
