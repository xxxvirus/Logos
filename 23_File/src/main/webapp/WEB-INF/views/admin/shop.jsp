...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-horizontal filter" action="/admin/shop" method="GET" modelAttribute="filter" >
			<custom:hiddenInputs excludeParams="_languageIds, _categoryIds, _publisherIds, languageIds, categoryIds, publisherIds, max, min"/>
			...
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/shop"
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:select class="form-control" path="shcat" id="category"
	...
	<div class="col-md-12 col-xs-12">
		...
		<c:forEach items="${page.content}" var="shop">
			<div class="row">
				<div class="col-md-1 col-xs-1"><img src="/images/shop/${shop.id}.jpg?version=${shop.version}" width="100%"></div>
